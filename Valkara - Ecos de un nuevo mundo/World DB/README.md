...
- [characters.md](characters.md) - PCs and NPCs, one entry each, updated as they reappear or change status.
- [locations.md](locations.md) - Places visited or referenced.
- [factions.md](factions.md) - Groups, organizations, and social forces at play.
- [timeline.md](timeline.md) - Chronological log of what happened, one entry per session.
- [plot-threads.md](plot-threads.md) - Open questions, split into Active and Resolved.
...
4. **plot-threads.md**:
   - For each question in the *Active* list, check whether the new session answered it. If so, move it to *Resolved* with a one-line resolution and the session date.
